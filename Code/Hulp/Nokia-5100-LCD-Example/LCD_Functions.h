...
const int scePin = 40;   // was 7 SCE - Chip select, pin 3 on LCD.
const int rstPin = 38;   // was 6 RST - Reset, pin 4 on LCD.
const int dcPin = 42;    // was 5 DC - Data/Command, pin 5 on LCD.
const int sdinPin = 44;  // was 11 DN(MOSI) - Serial data, pin 6 on LCD.
const int sclkPin = 46;  // was 13 SCLK - Serial clock, pin 7 on LCD.
const int blPin = 0;    // was 9 LED - Backlight LED, pin 8 on LCD.
